...
def search():
    if request.method == "GET":
        ...
        price_low = request.args['price_lower']
        price_high = request.args['price_upper']
    ...
    if request.method == "POST":
        ...
        abv_h = float(data['abv_upper'])
        abv_l = float(data['abv_lower'])
        degree_h = float(data['degree_upper'])
        degree_l = float(data['degree_lower'])
        year = int(data['year'])
        ml = int(data['ml'])
...
def modifier(wid):
    ...
    if request.method == "PATCH":
        ...
        varieties = int(data['varieties'])
        use = int(data['use'])
        abv_upper = float(data['abv_upper'])
        abv_lower = float(data['abv_lower'])
        degree_upper = float(data['degree_upper'])
        degree_lower = float(data['degree_lower'])
        ml = int(data['ml'])
        year = int(data['year'])
